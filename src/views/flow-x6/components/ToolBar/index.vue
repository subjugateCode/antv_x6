<template>
  <div class="bar">
    ...
    <el-tooltip class="item" effect="dark" content="横向翻转 " placement="bottom">
      <el-button name="transverse" @click="handleClick" class="item-space" size="small">
        横向
      </el-button>
    </el-tooltip>
    <el-tooltip class="item" effect="dark" content="纵向翻转" placement="bottom">
      <el-button name="portrait" @click="handleClick" class="item-space" size="small">
        纵向
      </el-button>
    </el-tooltip>
